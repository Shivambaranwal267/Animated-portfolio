      ...
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center mt-6 space-x-4">
          {[
            {
              icon: <FaFacebook />,
              link: "https://www.facebook.com/profile.php?id=100076635641578",
            },
            {
              icon: <FaLinkedin />,
              link: "https://www.linkedin.com/in/shivam-baranwal-38aa4a230/",
            },
            {
              icon: <FaInstagram />,
              link: "https://www.instagram.com/the___maximus___/",
            },
          ].map((item, index) => (
            <a
              key={index}
        ...
        <p className="mt-6 text-sm text-gray-400">
          © 2025 Shivam Baranwal. All rights reserved.
        </p>
      </div>
    </footer>
  );
